...
import { ProductAttributeWebhookService } from 'src/product/services/attribute/product-attribute-webhook.service';
...
export class ProductAttributeWebhookController {
  ...
  async productAttributeCreated_stag(@Body() data: any) {
  ...
  async productAttributeUpdated_stag(@Body() data: any) {
  ...
  async productAttributeDeleted_stag(@Body() data: any) {
  ...
  async productAttributeRestored_stag(@Body() data: any) {
  ...
  async productAttributeCreated_prod(@Body() data: any) {
  ...
  async productAttributeUpdated_prod(@Body() data: any) {
  ...
  async productAttributeDeleted_prod(@Body() data: any) {
  ...
  async productAttributeRestored_prod(@Body() data: any) {
