...
export default [Billing, CheckList, GuestHouse, Order, H2oUsim, UsimInfo, JfkOneway, JfkShuttleRt, LineItem, LineItemMetadata, Order, OrderMetadata, Payment, Shipping, SnapInfo, Tour, TourInfo];
